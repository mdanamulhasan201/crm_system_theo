    ...
    <nav className='bg-white border-b border-gray-200'>
      <div className='px-4 py-3 md:py-4 flex items-center justify-between relative'>
        <div className='flex items-center gap-2 ms-5'>
          <button onClick={onMenuClick} className='text-gray-600 cursor-pointer hover:text-gray-800 transition-all duration-300 md:hidden'>
            {isSidebarOpen ? <HiArrowLeft className='text-2xl' /> : <HiMenuAlt2 className='text-2xl' />}
          </button>
          <button
            onClick={handleBack}
        ...
        <div className='flex items-center space-x-2 md:space-x-4'>
          ...
          <div className='relative' ref={searchRef}>
            <HiSearch className='h-6 w-6 text-gray-600 hover:text-gray-800 cursor-pointer' onClick={() => setIsSearchVisible(!isSearchVisible)} />
