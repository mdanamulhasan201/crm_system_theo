        ...
        <div className="p-6 bg-gray-50 min-h-screen">
            ...
            <div className="mb-6">
                ...
                <div className="flex gap-4 mt-4 border-b border-gray-200">
                    <button className="px-4 py-2 text-gray-500 border-b-2 border-transparent hover:border-gray-300">
                        Kassenmanagement
                    </button>
                    <button className="px-4 py-2 text-[#61A175] border-b-2 border-[#61A175] font-medium">
                        Einnahmen
                    </button>
                </div>
            </div>
