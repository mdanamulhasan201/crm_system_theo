    ...
    return (
        <div className={`flex-shrink-0 ${className}`}>
            ...
            <div
                ...
                className={`${sizeClasses[size]} border border-gray-300 bg-gray-50 flex items-center justify-center cursor-pointer hover:bg-gray-100 transition-colors relative overflow-hidden`}
            >
                {imagePreview ? (
                    <>
                        <Image
