...
import Einstellungen from "../_components/Fragen/Einstellungen";
            ...
            <div className=" mt-10 font-sans">
                ...
                <div className="flex gap-3 mb-6">
                    <Button
                        ...
                        className={`px-6 py-2 cursor-pointer rounded-lg text-sm font-semibold transition-colors ${selectedType === "insoles"
                    ...
                    <Button
                        ...
                        className={`px-6 py-2 cursor-pointer rounded-lg text-sm font-semibold transition-colors ${selectedType === "shoes"
                            ? "bg-[#62A17C] text-white hover:bg-[#4A8A5F]"
                            : "bg-white text-gray-700 border border-gray-300 hover:bg-gray-50"
                            }`}
                    >
