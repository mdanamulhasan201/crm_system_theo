...
import { getShoeQuantityPerStatusData } from '@/apis/monatsstatistikApis';
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response: ApiResponse = await getShoeQuantityPerStatusData(selectedYear, selectedMonth);
                ...
                console.error('Error fetching shoe status data:', err);
