    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-5">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-500 mt-0.5">Customize your platform experience</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="pt-1">
          <label className="flex items-start gap-2 cursor-pointer">
            ...
            />
            <div>
              <div className="text-sm font-medium text-gray-900">Apply language to all employee accounts</div>
              <div className="text-xs text-gray-500">This will update the language preference for all team members</div>
            </div>
          </label>
        </div>
